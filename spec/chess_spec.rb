...
describe "The movement" do
  ...
  it "legal movement for the White pawn to a2 to a3 can go foward one square" do
    expect(ChessPawn.new('white').movement('a2', 'a3')).to eql('LEGAL')
  end

  it "legal movement for the White pawn to a2 to a1, a wP can't go backward" do
    expect(ChessPawn.new('white').movement('a2', 'a1')).to eql('ILLEGAL')
  end

  it "illegal movement if White pawn make a lateral movement" do
    expect(ChessPawn.new('white').movement('a2', 'f3')).to eql('ILLEGAL')
  end

  it "legal movement for the White pawn to a2 to a4" do
    expect(ChessPawn.new('white').movement('a2', 'a4')).to eql('LEGAL')
  end

  it "illegal movement for the White pawn to a3 to a5" do
    expect(ChessPawn.new('white').movement('a3', 'a5')).to eql('ILLEGAL')
  end

  it "illegal movement for the White pawn to a1 to a2" do
